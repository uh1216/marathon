...
public class UserInit {
    ...
    protected void init() {
        ...
        Doctor doctor1 = Doctor.builder()
            ...
            .introduce("젊고 건강한 분들도 영양제를 매일 챙겨 먹고 운동을 하며 몸을 꾸준히 관리하듯이, 재활 또한 단기간이 아닌 일상 속에서의 꾸준한 관리가 필요하다고 생각합니다.")
        ...
        Doctor doctor2 = Doctor.builder()
            ...
            .phone("01012341234")
            .introduce("수업이 화상으로 진행되다 보니 가끔 환자분들의 미세한 표정이나 상태들이 잘 보이지 않아 어려운 점은 있습니다. 하지만 그것보다 훨씬 많은 이점이 있다고 생각합니다.")
        ...
        Doctor doctor3 = Doctor.builder()
            ...
            .phone("01012341234")
            .introduce("체력적, 시간상으로 재활을 꾸준히 받기 힘드신 분들도 장소에 구애받지 않고 전자기기만 있으면 손쉽게 반복해서 복습을 할 수 있다는 건 큰 이점 입니다!")
