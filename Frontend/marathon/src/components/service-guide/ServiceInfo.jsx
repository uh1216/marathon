...
export default function ServiceInfo() {
  ...
  return (
    <div className={style.side_right_board}>
      <h1 style={{ animation: "1s loadEffect3" }}>언어 재활이 필요한 대상</h1>
      <div style={{ animation: "1s loadEffect3" }}>
        <hr />
        ...
        <div style={{ margin: "20px 0px" }}>
          <p>
            뇌졸중이나 뇌종양, 퇴행성 뇌질환(예: 파킨슨병, 알츠하이머), 사고
            등의 이유로 뇌손상이 발생하여 의사소통에 어려움을 겪는 증상입니다.
            말·언어문제가 일시적으로 나타나거나 점진적으로 퇴행할 수 있습니다.
            단어·문장을 이해하지 못하거나 의사표현을 자유롭게 하지 못하는
            실어증, 발음이 어눌하거나 자신의 생각대로 말소리가 산출되지 않는
            마비말장애와 말실행증, 인지기능의 저하로 의사전달이 어려운 인지-
            의사소통 장애까지 다양한 증상을 동반합니다.
          </p>
        </div>
      </div>
      <div style={{ animation: "1s loadEffect4" }}>
        <hr />
        ...
        >
          뇌손상으로 인해 언어를 이해·표현하는데 어려움을 보이는 후천적인
          의사소통 장애입니다. 지적·발달장애로 인한 언어장애와는 구별되며 뇌손상
          전에는 원활한 의사소통이 가능했던 경우입니다. 듣기, 말하기, 읽기, 쓰기
          중 한 가지 이상의 영역에서 제한을 보이며, 상대방의 말을 이해하기
          어렵거나 단어가 떠오르지 않아 의사표현이 힘든 경우, 글자를 읽거나
          받아쓰기, 글로 표현할 때 문제를 보일 수 있습니다.
        </div>
      </div>
      <div style={{ animation: "1.3s loadEffect4" }}>
        <hr />
        <div className={style.exp_box}>
          <div>
            <h4>마비말장애</h4>
        ...
        >
          말소리 산출에 관여하는 뇌신경 손상에 의해 나타나는 구음장애입니다.
          얼굴, 입술, 혀, 연구개 등 구강 근육의 마비 또는 약화로 인해 구어
          운동성 및 협응이 제한되어 호흡이 짧아지고, 쉬거나 쥐어짜는 듯한 목소리
          산출, 콧소리, 어눌한 발음, 불규칙적이거나 느려지는 말속도 등 말이
          명료하지 않은 증상을 보입니다.
        </div>
      </div>
      <div style={{ animation: "1.6s loadEffect4" }}>
        <hr />
        <div className={style.exp_box}>
          <div>
            <h4>말실행증</h4>
        ...
        >
          후천적인 뇌손상으로 인해 구강근육의 마비나 약화가 없음에도
          말소리(음소나 단어)를 정확하게 발음하는데 어려움을 겪는 증상입니다.
          머릿속으로 단어를 알고 있지만 자신의 의지대로 자동화 된 말 산출의
          순서가 계획/프로그래밍 되지 않아 말을 유창하게 구사하기 어려운
