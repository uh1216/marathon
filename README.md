...
<img src="./Docs/gif/지난수업기록확인.gif" width=450>
...
<img src="./Docs/gif/재활사회원가입카카오.gif" width=450>

- **[재활사 회원가입(카카오)] :** 일반 로그인 외에 카카오 계정을 통해 회원가입을 진행할 수 있다.

### 14. 재활사 일정관리

<img src="./Docs/gif/재활사일정관리.gif" width=450>
